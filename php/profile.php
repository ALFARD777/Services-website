...
<body id="top">
    <nav id="navigation-menu" class="navbar fixed-top navbar-expand-lg navbar-dark scrolling-navbar">
        <div class="container">
            ...
            <div class="text-center" id="navbarSupportedContent">
                ...
                <a class="nav-link btn btn-sm btn-orange btn-form cta-btn" href="basket.php">Корзина <i class="fas fa-shopping-basket animated tada delay-1s infinite ml-1"></i></a>
                <a class="nav-link btn btn-sm btn-orange btn-form cta-btn" onclick="doLogout()">Выход <i class="fas fa-door-open animated tada delay-1s infinite ml-1"></i></a>
            </div>
        </div>
    </nav>
    <header id="main" class="bg_img jarallax" data-jarallax='{"speed": 0.2}'>
        <div class="text-center">
            <div id="notificationContainer">

            </div>
            <h1 class="h1-responsive display-4">Профиль</h1>
            <hr class="hr-light-h">
            <table>
                <tr>
                ...
                <tr>
                    ...
                    <td class="table-left">
                        <input type="text" id="newName" class="profile form-control" style="display: inline !important; height: calc(1.7rem + 2px); width:auto; background-color: #00000030; color: #fff;" value="<?php
                                                                                                                                                                                                                    $host = 'localhost';
                                                                                                                                                                                                                    $username = 'root';
                                                                                                                                                                                                                    $password = '';
                                                                                                                                                                                                                    $database = 'services';
                ...
                <tr>
                    ...
                    <td class="table-left">
                        <input type="text" id="newPhone" class="profile form-control" style="display: inline !important; height: calc(1.7rem + 2px); width:auto; background-color: #00000030; color: #fff;" value="<?php
                                                                                                                                                                                                                    $host = 'localhost';
                                                                                                                                                                                                                    $username = 'root';
                                                                                                                                                                                                                    $password = '';
                                                                                                                                                                                                                    $database = 'services';
                ...
                <tr>
                    ...
                    <td class="table-left">
                        <input type="text" id="newAddress" class="profile form-control" style="display: inline !important; height: calc(1.7rem + 2px); width:auto; background-color: #00000030; color: #fff;" value="<?php
                                                                                                                                                                                                                        $host = 'localhost';
                                                                                                                                                                                                                        $username = 'root';
                                                                                                                                                                                                                        $password = '';
                                                                                                                                                                                                                        $database = 'services';
                ...
                <tr>
                    <td class="table-right">
                        <p class="lead">Новый пароль:</p>
                    </td>
                    <td class="table-left">
                        <input id="newPassword" type="password" class="profile form-control" style="display: inline !important; height: calc(1.7rem + 2px); width:auto; background-color: #00000030; color: #fff;">
                    </td>
                </tr>
            </table>
            <div class="flex-center">
                <button class="btn btn-lg btn-orange cta-btn mt-3 mb-5" onclick="saveProfile('<?php echo $_COOKIE['login']; ?>')" id="saveProfile">Сохранить&nbsp;
                    <i class="far fa-save animated tada delay-1s infinite ml-1"></i>
                </button>
            </div>
        </div>
    </header>
    ...
    <script src="/Services/js/profile.js"></script>
